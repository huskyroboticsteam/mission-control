...
export const HelpPanel = () => {
  ...
  const [buttonChange, setButtonChange] = useState<{gpadIndex: number, gpad: EGamepad | Gamepad, buttonChanges: readonly (false | buttonChangeDetails)[]} | null>(null)
  const [axisChange, setAxisChange] = useState<{gpadIndex: number, gpad: EGamepad | Gamepad, axisChangesMask: readonly boolean[]} | null>(null)
