...
function SvgComponent(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M163 140.769c6 29.375 13.537 33.424 35.28 43.583 35.355 16.519 33.138 57.105 56.59 45.51 14.36-7.1 21.13-19.23 21.13-38.4 0-24.92-11.42-65.99-32.4-119.1-10.625-22.199-25.844-16.641-42.794-16.641-7.93 0-15.744-1.226-22.454 2.224-14.564 7.511-21.031 55.022-15.352 82.824z" />
      <text
        x="169.251px"
        y="222.47px"
      ...
      <circle cx={194.79} cy={176.272} r={26.46} fillOpacity={0.5} />
      <circle
        cx={193.55}
        cy={175.022}
        r={25.21}
      ...
      />
      <path
        d="M193.55 179.261v-8.477h25.441v-3.768a1.7 1.7 0 012.902-1.202l8.006 8.006a1.7 1.7 0 010 2.404l-8.006 8.006a1.7 1.7 0 01-2.902-1.202v-3.767H193.55z"
        fill="#ff00bf"
      />
      <path
        d="M189.311 175.022h8.478v25.441h3.767a1.7 1.7 0 011.202 2.903l-8.006 8.006a1.702 1.702 0 01-2.404 0l-8.006-8.006a1.7 1.7 0 011.202-2.903h3.767v-25.441z"
        fill="#ff00bf"
      />
      <path
        d="M193.55 170.784v8.477h-25.441v3.767a1.7 1.7 0 01-2.902 1.202l-8.006-8.006a1.7 1.7 0 010-2.404l8.006-8.006a1.7 1.7 0 012.902 1.202v3.768h25.441z"
        fill="#ff00bf"
      />
      <path
        d="M197.789 175.022h-8.478v-25.441h-3.767a1.7 1.7 0 01-1.202-2.902l8.006-8.006a1.7 1.7 0 012.404 0l8.006 8.006a1.7 1.7 0 01-1.202 2.902h-3.767v25.441z"
        fill="#ff00bf"
      />
      <circle cx={195.41} cy={176.892} r={17.12} fillOpacity={0.5} />
      <use
        xlinkHref="#_Image1"
        x={161}
        y={142}
      ...
      />
      <circle cx={193.55} cy={175.022} r={17.15} fill="#fff" />
      <path d="M193.55 157.872c9.465 0 17.15 7.685 17.15 17.15s-7.685 17.15-17.15 17.15-17.15-7.685-17.15-17.15 7.685-17.15 17.15-17.15zm0 2.689c-7.981 0-14.461 6.48-14.461 14.461s6.48 14.461 14.461 14.461 14.461-6.48 14.461-14.461-6.48-14.461-14.461-14.461z" />
      <circle cx={193.55} cy={175.022} r={13.111} fill="#fff" />
      <path d="M193.55 161.911c7.236 0 13.111 5.875 13.111 13.111 0 7.236-5.875 13.111-13.111 13.111-7.236 0-13.111-5.875-13.111-13.111 0-7.236 5.875-13.111 13.111-13.111zm0 1.35c-6.491 0-11.761 5.27-11.761 11.761s5.27 11.761 11.761 11.761 11.761-5.27 11.761-11.761-5.27-11.761-11.761-11.761z" />
      <path
        d="M182.219 132.023a8.685 8.685 0 012.89 6.477 8.685 8.685 0 01-2.89 6.477h-11.638a8.685 8.685 0 01-2.89-6.477 8.685 8.685 0 012.89-6.477h11.638z"
        fill="#9a9a9a"
        fillOpacity={0.5}
      />
      <use
        ...
        width="46px"
        height="41px"
        transform="translate(-527.352 -264.931) scale(1.02273)"
      />
      <path
        d="M181.245 131.064a8.691 8.691 0 012.889 6.478 8.69 8.69 0 01-2.889 6.477h-11.639a8.688 8.688 0 01-2.89-6.477 8.688 8.688 0 012.89-6.478h11.639z"
        fill="#fff"
      />
      <path d="M181.245 131.064a8.691 8.691 0 012.889 6.478 8.69 8.69 0 01-2.889 6.477h-11.639a8.688 8.688 0 01-2.89-6.477 8.688 8.688 0 012.89-6.478h11.639zm-.543 1.351h-10.554a7.334 7.334 0 00-2.082 5.127c0 1.992.794 3.801 2.083 5.127l10.553-.001a7.333 7.333 0 002.082-5.126 7.334 7.334 0 00-2.082-5.127z" />
      <path
        d="M173.045 134.516l6.117 3.029-6.11 3.022v-6.051h-.007z"
        fill="none"
        stroke="#000"
        strokeWidth="1.12px"
      ...
      <g>
        ...
        <use
          ...
          transform="translate(.25)"
        />
        <circle cx={197.24} cy={121.007} r={11.8} fill="#00ff04" />
        <path d="M197.24 109.207c6.512 0 11.8 5.287 11.8 11.8 0 6.512-5.288 11.8-11.8 11.8-6.513 0-11.8-5.288-11.8-11.8 0-6.513 5.287-11.8 11.8-11.8zm0 1.72c-5.563 0-10.08 4.516-10.08 10.08 0 5.563 4.517 10.079 10.08 10.079s10.079-4.516 10.079-10.079c0-5.564-4.516-10.08-10.079-10.08z" />
        <g
          fill="none"
          stroke="#000"
          strokeWidth="1.72px"
          ...
          strokeLinejoin="round"
        >
          <path d="M193.595 117.35l7.72 7.731M193.595 125.081l7.72-7.731" />
        </g>
      </g>
      <g>
        <circle
        ...
        <use
          ...
          transform="translate(.25)"
        />
        <circle cx={218.101} cy={100.145} r={11.8} fill="#ff0009" />
        <path d="M218.101 88.345c6.513 0 11.8 5.288 11.8 11.8 0 6.513-5.287 11.8-11.8 11.8-6.513 0-11.8-5.287-11.8-11.8 0-6.512 5.287-11.8 11.8-11.8zm0 1.721c-5.563 0-10.079 4.516-10.079 10.079 0 5.563 4.516 10.08 10.079 10.08 5.563 0 10.08-4.517 10.08-10.08s-4.517-10.079-10.08-10.079z" />
        <circle
          cx={218.101}
          cy={100.145}
          r={4.505}
      ...
      <g>
        ...
        <use
          ...
          transform="translate(.25)"
        />
        <circle cx={176.39} cy={100.145} r={11.8} fill="#48c0fb" />
        <path d="M176.39 88.345c6.512 0 11.8 5.288 11.8 11.8 0 6.513-5.288 11.8-11.8 11.8-6.513 0-11.8-5.287-11.8-11.8 0-6.512 5.287-11.8 11.8-11.8zm0 1.7c-5.575 0-10.1 4.526-10.1 10.1 0 5.575 4.525 10.1 10.1 10.1 5.574 0 10.1-4.525 10.1-10.1 0-5.574-4.526-10.1-10.1-10.1z" />
        <path
          d="M180.895 96.371v7.258a.884.884 0 01-.883.883h-7.244a.883.883 0 01-.883-.883v-7.258c0-.487.395-.883.883-.883h7.244c.487 0 .883.396.883.883z"
          fill="none"
          stroke="#000"
          strokeWidth="1.7px"
          strokeLinecap="round"
      ...
      <g>
        ...
        <use
          ...
          transform="translate(.25)"
        />
        <circle cx={197.24} cy={79.295} r={11.8} fill="#fff000" />
        <path d="M197.24 67.495c6.512 0 11.8 5.288 11.8 11.8 0 6.513-5.288 11.8-11.8 11.8-6.513 0-11.8-5.287-11.8-11.8 0-6.512 5.287-11.8 11.8-11.8zm0 1.721c-5.563 0-10.08 4.516-10.08 10.079 0 5.563 4.517 10.08 10.08 10.08s10.079-4.517 10.079-10.08-4.516-10.079-10.079-10.079z" />
        <path
          d="M192.735 83.302l4.641-9.372 4.629 9.361h-9.27v.011z"
          fill="none"
          stroke="#000"
          strokeWidth="1.72px"
          strokeLinejoin="round"
      ...
      <g>
        <path
          d="M161.085 30.441h-5.073a1.7 1.7 0 00-1.471 2.551l9.322 16.121a1.7 1.7 0 002.944 0l9.298-16.08a1.726 1.726 0 00-1.496-2.592h-5.024V10.957h-.002a8.498 8.498 0 00-8.498 8.498v10.986z"
          fill="#ff00bf"
        />
        <path
          d="M226 40.321a1.7 1.7 0 001.7-1.7V18.479a6 6 0 00-6-6h-18.295a9 9 0 00-8.172 5.23l-9.32 20.199a1.699 1.699 0 001.544 2.413H226z"
          fillOpacity={0.5}
        />
        <use
          xlinkHref="#_Image7"
          ...
          width="76px"
          height="55px"
          transform="matrix(-1 0 0 1 788 -256)"
        />
        <path
          d="M224.44 38.798a1.7 1.7 0 001.7-1.7V16.957a6 6 0 00-6-6h-18.295a9 9 0 00-8.172 5.229l-9.32 20.2a1.698 1.698 0 001.544 2.412h38.543z"
          fill="#fff"
        />
        <path d="M224.44 38.798h-38.543a1.698 1.698 0 01-1.544-2.412l9.32-20.2a9 9 0 018.172-5.229h18.295a6.002 6.002 0 016 6v20.141a1.7 1.7 0 01-1.7 1.7zm0-1.7V16.957a4.302 4.302 0 00-4.3-4.3h-18.295a7.3 7.3 0 00-6.628 4.241l-9.233 20.011c.02.01.038.021.055.034.02.005.036.026.048.055l.006.017a.36.36 0 01.013.083h38.334c-.939 0 0-.939 0 0z" />
      </g>
      <g>
        <path
          d="M185.1 44.7a6.003 6.003 0 00-4.243 1.757A6.003 6.003 0 00179.1 50.7v7.6a1.7 1.7 0 001.7 1.7h46.4a1.7 1.7 0 001.7-1.7v-7.585a6.015 6.015 0 00-6.015-6.015H185.1z"
          fill="#9a9a9a"
          fillOpacity={0.5}
        />
        <use xlinkHref="#_Image8" x={163} y={28} width="80px" height="46px" />
        <path
          d="M184.069 43.65a6 6 0 00-6 6v7.6a1.7 1.7 0 001.7 1.7h46.4a1.7 1.7 0 001.7-1.7v-7.585a6.015 6.015 0 00-6.015-6.015h-37.785z"
          fill="#fff"
        />
        <path d="M184.069 43.65h37.785a6.015 6.015 0 016.015 6.015v7.585a1.7 1.7 0 01-1.7 1.7h-46.4a1.7 1.7 0 01-1.7-1.7v-7.6a6 6 0 016-6zm41.964 13.599a.439.439 0 00.006-.019c-.033-.019-.008-.05.034-.076.026-.043.057-.067.077-.034.006-.003.013-.004.019-.006v-7.449a4.315 4.315 0 00-4.315-4.315h-37.785a4.3 4.3 0 00-4.3 4.3v7.465a.07.07 0 01.019.006c.021-.037.056-.006.083.043.022.017.034.036.024.052a.618.618 0 01.01.034l46.128-.001z" />
      </g>
      <path
        d="M187.091 141.791a34.686 34.686 0 016.374-.588c19.07 0 34.552 15.482 34.552 34.552s-15.482 34.552-34.552 34.552c-19.069 0-34.551-15.482-34.551-34.552 0-10.648 4.827-20.178 12.411-26.518 1.298.465 2.697.718 4.155.718 5.345 0 9.9-3.406 11.611-8.164z"
        fill="#419bf3"
        fillOpacity={0.25}
      />
      <path
        d="M187.417 134.497c.26.997.399 2.043.399 3.122 0 6.809-5.528 12.336-12.336 12.336-6.808 0-12.336-5.527-12.336-12.336s5.528-12.337 12.336-12.337c2.48 0 4.789.734 6.723 1.995a16.16 16.16 0 005.214 7.22z"
        fill="#f38f41"
        fillOpacity={0.25}
      />
      <path
        d="M191.877 106.677a16.066 16.066 0 015.496-.963c1.93 0 3.781.34 5.496.963l9.655 9.656c.623 1.715.963 3.566.963 5.496 0 8.894-7.22 16.114-16.114 16.114-8.894 0-16.115-7.22-16.115-16.114 0-1.93.34-3.781.963-5.496l9.656-9.656z"
        fill="#41f352"
        fillOpacity={0.25}
      />
      <path
        d="M212.731 85.823a16.066 16.066 0 015.496-.963c8.894 0 16.114 7.221 16.114 16.115 0 8.894-7.22 16.114-16.114 16.114-2.186 0-4.271-.436-6.173-1.226l-8.715-8.715a16.056 16.056 0 01-1.227-6.173c0-1.93.34-3.781.963-5.496l9.656-9.656z"
        fill="#f34146"
        fillOpacity={0.25}
      />
      <path
        d="M182.692 115.863a16.056 16.056 0 01-6.173 1.226c-8.894 0-16.115-7.22-16.115-16.114 0-8.894 7.221-16.115 16.115-16.115 1.93 0 3.781.34 5.495.963l9.656 9.656c.623 1.715.963 3.566.963 5.496 0 2.186-.436 4.271-1.226 6.173l-8.715 8.715z"
        fill="#419bf3"
        fillOpacity={0.25}
      />
      <path
        d="M182.485 86.294a16.056 16.056 0 01-1.227-6.173c0-8.894 7.221-16.115 16.115-16.115 8.894 0 16.114 7.221 16.114 16.115 0 2.186-.436 4.271-1.226 6.173l-8.715 8.715a16.056 16.056 0 01-6.173 1.226c-2.186 0-4.271-.436-6.173-1.226l-8.715-8.715z"
        fill="#f3ea41"
        fillOpacity={0.25}
      />
      <path
        d="M231.727 41.355V3.448h-40.921l-17.489 37.907h58.41z"
        fill="#419bf3"
        fillOpacity={0.25}
      />
      <path
        fill="#8141f3"
        fillOpacity={0.25}
        d="M170.599 41.355H235.339V63.678H170.599z"
      />
      <g>
        <path d="M113 140.769c-6 29.375-13.537 33.424-35.28 43.583-35.355 16.519-33.138 57.105-56.59 45.51-14.36-7.1-21.13-19.23-21.13-38.4 0-24.92 11.42-65.99 32.4-119.1 10.625-22.199 25.844-16.641 42.794-16.641 7.93 0 15.744-1.226 22.454 2.224 14.564 7.511 21.031 55.022 15.352 82.824z" />
        <text
          x="58.772px"
          y="222.614px"
          fontFamily="'ArialRoundedMTBold','Arial Rounded MT Bold',sans-serif"
        ...
        <circle cx={82.237} cy={176.33} r={26.46} fillOpacity={0.5} />
        <circle
          cx={80.987}
          cy={175.09}
          r={25.21}
        ...
        />
        <path
          d="M80.987 179.329v-8.477h25.442v-3.768a1.7 1.7 0 012.902-1.202l8.006 8.006a1.7 1.7 0 010 2.404l-8.006 8.006a1.7 1.7 0 01-2.902-1.202v-3.767H80.987z"
          fill="#ff00bf"
        />
        <path
          d="M76.749 175.09h8.477v25.442h3.767a1.7 1.7 0 011.203 2.902l-8.006 8.006a1.7 1.7 0 01-2.405 0l-8.005-8.006a1.7 1.7 0 011.202-2.902h3.767V175.09z"
          fill="#ff00bf"
        />
        <path
          d="M80.987 170.852v8.477H55.545v3.767a1.7 1.7 0 01-2.902 1.202l-8.006-8.006a1.703 1.703 0 010-2.404l8.006-8.006a1.701 1.701 0 012.902 1.202v3.768h25.442z"
          fill="#ff00bf"
        />
        <path
          d="M85.225 175.09h-8.477v-25.441h-3.767a1.701 1.701 0 01-1.202-2.902l8.006-8.006a1.7 1.7 0 012.404 0l8.006 8.006a1.699 1.699 0 01-1.202 2.902h-3.768v25.441z"
          fill="#ff00bf"
        />
        <circle cx={82.847} cy={176.96} r={17.12} fillOpacity={0.5} />
        <use
          xlinkHref="#_Image9"
          x={48}
          y={143}
          ...
          transform="translate(.25)"
        />
        <circle cx={80.987} cy={175.09} r={17.15} fill="#fff" />
        <path d="M80.987 157.94c9.466 0 17.15 7.685 17.15 17.15s-7.684 17.15-17.15 17.15c-9.465 0-17.15-7.685-17.15-17.15s7.685-17.15 17.15-17.15zm0 2.5c-8.085 0-14.65 6.564-14.65 14.65s6.565 14.65 14.65 14.65c8.086 0 14.65-6.564 14.65-14.65s-6.564-14.65-14.65-14.65z" />
        <g>
          <circle cx={80.987} cy={175.09} r={13.111} fill="#fff" />
          <path d="M80.987 161.979c7.236 0 13.111 5.875 13.111 13.111 0 7.236-5.875 13.111-13.111 13.111-7.236 0-13.111-5.875-13.111-13.111 0-7.236 5.875-13.111 13.111-13.111zm0 1.35c-6.491 0-11.761 5.27-11.761 11.761s5.27 11.761 11.761 11.761 11.761-5.27 11.761-11.761-5.27-11.761-11.761-11.761z" />
        </g>
        <g>
          <path
            d="M106.075 132.272a8.623 8.623 0 012.867 6.428 8.623 8.623 0 01-2.867 6.428h-11.55a8.623 8.623 0 01-2.867-6.428 8.623 8.623 0 012.867-6.428h11.55z"
            fill="#9a9a9a"
            fillOpacity={0.5}
          />
          <use
            ...
            width="43px"
            height="39px"
            transform="translate(-14.593 -20.56) scale(1.14878)"
          />
          <path
            d="M105.066 131.238a8.622 8.622 0 012.868 6.428 8.62 8.62 0 01-2.868 6.427H93.517a8.62 8.62 0 01-2.868-6.427 8.622 8.622 0 012.868-6.428h11.549z"
            fill="#fff"
          />
          <path d="M105.066 131.238a8.622 8.622 0 012.868 6.428 8.62 8.62 0 01-2.868 6.427H93.517a8.62 8.62 0 01-2.868-6.427 8.622 8.622 0 012.868-6.428h11.549zm-.542 1.35H94.059a7.274 7.274 0 00-2.06 5.078c0 1.973.786 3.764 2.061 5.077h10.464a7.27 7.27 0 002.06-5.077 7.274 7.274 0 00-2.06-5.078z" />
          <path
            d="M95.383 139.64h7.817c.534-.634.547-1.279 0-1.939h-7.817c-.555-.647-.546-1.305 0-1.974h7.817"
            fill="none"
            stroke="#000"
            strokeWidth=".9px"
            strokeLinecap="round"
        ...
        <g>
          <path
            d="M68.911 109.039a.853.853 0 00-.85-.85H50.322a1.67 1.67 0 01-1.671-1.671V91.282a1.671 1.671 0 011.671-1.671h17.739a.853.853 0 00.85-.85v-17.71a1.7 1.7 0 011.7-1.7h15.207a1.671 1.671 0 011.671 1.671v17.739a.853.853 0 00.85.85h17.739a1.67 1.67 0 011.671 1.671v15.236a1.671 1.671 0 01-1.671 1.671H88.339a.853.853 0 00-.85.85v17.739a1.67 1.67 0 01-1.671 1.671H70.582a1.671 1.671 0 01-1.671-1.671v-17.739z"
            fill="#9a9a9a"
            fillOpacity={0.05}
          />
          <use
            ...
            width="48px"
            height="53px"
            transform="translate(-1.614 -3.025) scale(1.01954)"
          />
          <use
            xlinkHref="#_Image12"
            x={53}
          ...
          />
          <path
            d="M67.903 108.022a.85.85 0 00-.85-.85H49.314a1.671 1.671 0 01-1.67-1.671V90.264a1.67 1.67 0 011.67-1.671h17.739a.848.848 0 00.85-.85V70.034a1.7 1.7 0 011.7-1.7h15.208a1.67 1.67 0 011.67 1.671v17.738a.85.85 0 00.85.85h17.739c.443 0 .868.176 1.181.49.314.313.49.738.49 1.181v15.237a1.671 1.671 0 01-1.671 1.671H87.331a.852.852 0 00-.85.85v17.738a1.67 1.67 0 01-1.67 1.671H69.574c-.443 0-.868-.176-1.182-.489a1.675 1.675 0 01-.489-1.182v-17.738z"
            fill="#fff"
          />
          <path d="M67.903 108.022a.85.85 0 00-.85-.85H49.314a1.671 1.671 0 01-1.67-1.671V90.264a1.67 1.67 0 011.67-1.671h17.739a.848.848 0 00.85-.85V70.034a1.7 1.7 0 011.7-1.7h15.208a1.67 1.67 0 011.67 1.671v17.738a.85.85 0 00.85.85h17.739c.443 0 .868.176 1.181.49.314.313.49.738.49 1.181v15.237a1.671 1.671 0 01-1.671 1.671H87.331a.852.852 0 00-.85.85v17.738a1.67 1.67 0 01-1.67 1.671H69.574c-.443 0-.868-.176-1.182-.489a1.675 1.675 0 01-.489-1.182v-17.738zM49.359 90.309v15.147h17.694l.503.049.479.146.442.236.39.32.321.391.236.442.145.479.05.503v17.693h15.146v-17.693l.05-.503.146-.479.235-.442.321-.391.391-.32.441-.236.479-.146.503-.049h17.694V90.309H87.331l-.503-.05-.479-.145-.441-.236-.391-.32-.321-.391-.235-.442-.146-.479-.05-.503V70.05H69.619v17.693l-.05.503-.145.479-.236.442-.321.391-.39.32-.442.236-.479.145-.503.05H49.359z" />
          <path
            d="M91.96 93.246l9.273 4.631-9.284 4.653v-9.295l.011.011zM62.406 102.519l-9.284-4.642 9.284-4.642v9.284zM81.819 112.649l-4.641 9.284-4.642-9.284h9.283zM72.536 83.105l4.652-9.283 4.631 9.283h-9.283z"
            fill="none"
            stroke="#000"
            strokeWidth="1.69px"
            strokeLinejoin="round"
        ...
        <g>
          <path
            d="M114.915 30.441h5.073a1.7 1.7 0 011.471 2.551l-9.322 16.121a1.7 1.7 0 01-2.944 0l-9.298-16.08a1.726 1.726 0 011.496-2.592h5.024V10.957h.002a8.498 8.498 0 018.498 8.498v10.986z"
            fill="#ff00bf"
          />
          <path
            d="M53.55 40.321a1.7 1.7 0 01-1.7-1.7V18.479a6 6 0 016-6h18.295a9 9 0 018.172 5.23l9.32 20.199a1.699 1.699 0 01-1.544 2.413H53.55z"
            fillOpacity={0.5}
          />
          <use xlinkHref="#_Image15" x={32} y={0} width="76px" height="54px" />
          <path
            d="M51.56 38.798a1.7 1.7 0 01-1.7-1.7V16.957a6 6 0 016-6h18.295a9 9 0 018.172 5.229l9.32 20.2a1.698 1.698 0 01-1.544 2.412H51.56z"
            fill="#fff"
          />
          <path d="M51.56 38.798a1.7 1.7 0 01-1.7-1.7V16.957a6 6 0 016-6h18.295a9 9 0 018.172 5.229l9.32 20.2a1.698 1.698 0 01-1.544 2.412H51.56zm38.335-1.7a.33.33 0 01.008-.064c-.003-.02.008-.043.028-.064a.328.328 0 01.085-.061l-9.233-20.011a7.3 7.3 0 00-6.628-4.241H55.86a4.302 4.302 0 00-4.3 4.3v20.141h38.335z" />
        </g>
        <g>
          <path
            d="M92.9 44.65c1.591 0 3.117.632 4.243 1.757A6.003 6.003 0 0198.9 50.65v7.6a1.7 1.7 0 01-1.7 1.7H50.8a1.7 1.7 0 01-1.7-1.7v-7.585a6.015 6.015 0 016.015-6.015H92.9z"
            fill="#9a9a9a"
            fillOpacity={0.5}
          />
          <use xlinkHref="#_Image16" x={33} y={28} width="80px" height="46px" />
          <path
            d="M91.931 43.65a6 6 0 016 6v7.6a1.7 1.7 0 01-1.7 1.7h-46.4a1.7 1.7 0 01-1.7-1.7v-7.585a6.015 6.015 0 016.015-6.015h37.785z"
            fill="#fff"
          />
          <path d="M91.931 43.65a6 6 0 016 6v7.6a1.7 1.7 0 01-1.7 1.7h-46.4a1.7 1.7 0 01-1.7-1.7v-7.585a6.015 6.015 0 016.015-6.015h37.785zm4.164 13.599l.005-.019c-.033-.019-.008-.05.035-.076.026-.043.057-.067.076-.034l.02-.006V49.65a4.3 4.3 0 00-4.3-4.3H54.146a4.315 4.315 0 00-4.315 4.315v7.45a.082.082 0 01.019.006c.021-.037.056-.006.083.043.022.017.033.036.023.052a.267.267 0 01.011.034l46.128-.001z" />
        </g>
        <path
          d="M103.913 149.248c7.13 6.332 11.626 15.566 11.626 25.842 0 19.07-15.482 34.552-34.552 34.552-19.069 0-34.551-15.482-34.551-34.552s15.482-34.552 34.551-34.552c2.159 0 4.271.199 6.32.578 1.498 5.206 6.3 9.018 11.985 9.018a12.41 12.41 0 004.621-.886z"
          fill="#419bf3"
          fillOpacity={0.25}
        />
        <path
          d="M97.301 125.355a12.567 12.567 0 011.991-.158c6.881 0 12.468 5.587 12.468 12.469 0 6.881-5.587 12.468-12.468 12.468-6.882 0-12.469-5.587-12.469-12.468 0-3.13 1.155-5.992 3.063-8.182a34.017 34.017 0 007.415-4.129z"
          fill="#f37f41"
          fillOpacity={0.25}
        />
        <g fillOpacity={0.25}>
          <path
            d="M45.065 86.582a34.176 34.176 0 0120.827-20.827v20.827H45.065z"
            fill="#497d7f"
          />
          <path
            d="M65.892 130.009a34.176 34.176 0 01-20.827-20.827h20.827v20.827z"
            fill="#617333"
          />
          <path
            d="M109.319 109.182a34.176 34.176 0 01-20.827 20.827v-20.827h20.827z"
            fill="#552525"
          />
          <path
            d="M88.492 65.755a34.176 34.176 0 0120.827 20.827H88.492V65.755z"
            fill="#634669"
          />
          <path
            d="M65.892 109.182H45.065a33.961 33.961 0 01-1.923-11.3c0-3.96.678-7.763 1.923-11.3h20.827l11.3 11.3-11.3 11.3z"
            fill="#b851b5"
          />
          <path
            d="M65.892 109.182l11.3-11.3 11.3 11.3v20.827a33.94 33.94 0 01-11.3 1.923c-3.96 0-7.763-.677-11.3-1.923v-20.827z"
            fill="#51b882"
          />
          <path
            d="M88.492 109.182l-11.3-11.3 11.3-11.3h20.827a33.945 33.945 0 011.923 11.3c0 3.961-.677 7.764-1.923 11.3H88.492z"
            fill="#5166b8"
          />
          <path
            d="M65.892 86.582V65.755a33.97 33.97 0 0111.3-1.923c3.96 0 7.764.678 11.3 1.923v20.827l-11.3 11.3-11.3-11.3z"
            fill="#b7b851"
          />
        </g>
        <path
          d="M44.273 41.355V3.448h40.921l17.489 37.907h-58.41z"
          fill="#419bf3"
          fillOpacity={0.2}
        />
        <path
          fill="#7041f3"
          fillOpacity={0.2}
          d="M40.661 41.355H105.401V63.678H40.661z"
        />
      </g>
      <defs>
        <image
