...
function LeftSuspension() {
  ...
  return <primitive object={mesh} position={[-25, 7.5, 0]} />
}
...
function FrontLeftWheel() {
  ...
  return <primitive object={mesh} position={[-38.5, -5, 32.5]} />
}
...
function ArmBase() {
  ...
  return (
    <primitive object={mesh} position={[0, 15, 30]} rotation={[0, degToRad(position), 0]}>
...
function LowerArm({position}) {
  ...
  return (
    <group position={position} rotation={[-degToRad(jointPos), 0, 0]}>
...
function Forearm({position}) {
  ...
  return (
    <primitive object={mesh} position={position} rotation={[0, 0, degToRad(jointPos)]}>
      <Wrist />
    </primitive>
  )
}
...
function Wrist() {
  ...
  return (
    <primitive object={mesh} position={[0, 0, 12.5]} rotation={[degToRad(-position), 0, 0]}>
      <Hand />
    </primitive>
  )
}
...
function Hand() {
  ...
  return (
    <primitive object={baseMesh} position={[0, 0, 21.5]}>
      <primitive object={leftMesh} position={[4, 0, 2]} rotation={[0, degToRad(position), 0]} />
      <primitive object={rightMesh} position={[-4, 0, 2]} rotation={[0, degToRad(-position), 0]} />
    </primitive>
  )
}
...
function ArmSegment({length}) {
  return (
    <>
      <Box args={[6, 6, length]} position={[0, 0, length / 2]} material-color="#6C6C76" />
      <Cylinder
        args={[5, 5, 5, 20]}
        position={[0, 0, length]}
