...
function InputInfo() {
  ...
  if (mountedPeripheral === 'arm') peripheralGamepadLabel = 'Arm'
  else if (mountedPeripheral === 'scienceStation') peripheralGamepadLabel = 'Science'
  else peripheralGamepadLabel = 'Peripheral'
