...
import {
  requestSwerveDriveMode,
  selectSwerveDriveMode,
  selectSwerveDriveOverride,
} from '../../store/swerveDriveModeSlice'
    ...
    <div className="swerveDriveMode">
      <div className="rover">
        ...
        <div>
          <button
            disabled
            className={'front left wheel'}
            style={{transform: `rotate(${-lfPos}deg)`}}
          />
          <button
            disabled
            className={'front right wheel'}
            style={{transform: `rotate(${-rfPos}deg)`}}
          />
          <button
            disabled
            className={'back left wheel'}
            style={{transform: `rotate(${-lrPos}deg)`}}
          />
          <button
            disabled
            className={'back right wheel'}
            style={{transform: `rotate(${-rrPos}deg)`}}
          />
        </div>
      </div>
    </div>
