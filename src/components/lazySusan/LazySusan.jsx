...
function LazySusan() {
  ...
  useEffect(() => {
    ...
    clear(context)
    context.beginPath()
    context.ellipse(300, 165, 50 * 5, 25 * 5, 0, 0, 2 * Math.PI)
    context.fillStyle = 'white'
    context.fill()

    context.beginPath()
    context.ellipse(2 * r + add, 0 + add_y, 20 * 3, 10 * 3, 0, 0, 2 * Math.PI)
    ...
    context.beginPath()
    context.ellipse(2 * (0.5 * r) + add, 0.866 * r + add_y, 20 * 3, 10 * 3, 0, 0, 2 * Math.PI)
    context.fillStyle = 'grey'
    if (position === 2) {
      context.fillStyle = 'pink'
    }
    ...
    context.beginPath()
    context.ellipse(2 * (-1 * r) + add, 0 + add_y, 20 * 3, 10 * 3, 0, 0, 2 * Math.PI)
    context.fillStyle = 'grey'
    if (position === 4) {
      context.fillStyle = 'pink'
    }
