...
```
{
  ...
  joint: "armBase" | "shoulder" | "elbow" | "forearm" | "wristPitch" | "wristRoll" | "hand" | "handActuator" | "drillMotor" | "ikForward" | "ikUp",
  power: number
}
```
...
```
{
  ...
  joint: "armBase" | "shoulder" | "elbow" | "forearm" | "wristPitch" | "wristRoll" | "hand" | "drillMotor",
  position: number
}
```
